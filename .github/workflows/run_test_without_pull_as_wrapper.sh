...
$puller /data/data/$applicationId/cache/test/activityScreenshot.png
rm activityScreenshot.png
echo

echo "Pulling a single file into specified directory"
mkdir test_tmp
$puller /data/data/$applicationId/cache/test/activityScreenshot.png test_tmp
rm test_tmp/activityScreenshot.png
rmdir test_tmp
echo

echo "Pulling directory into current directory"
$puller /data/data/$applicationId/cache/test
...
mkdir test_tmp
$puller /data/data/$applicationId/cache/test test_tmp
...
mkdir test_tmp
$puller /data/data/$applicationId/cache/test/activityScreenshot.png /data/data/$applicationId/cache/test/activityScreenshot.png test_tmp
rm test_tmp/activityScreenshot.png
rmdir test_tmp
echo
